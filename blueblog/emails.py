'''
Author: han wu 
Date: 2021-12-23 09:37:41
LastEditTime: 2021-12-25 22:26:05
LastEditors: your name
Description: 电子邮件
FilePath: /BlueBlog_Demo/blueblog/emails.py
~~~~~~~~~吼吼吼~~~~~~~~~~
'''
...
def send_new_comment_email(post):
    ...
    send_mail(
        subject="New comment", to=current_app.config['BLUEBLOG_EMAIL'],
